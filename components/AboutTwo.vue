          ...
          <div class="row">
              <div class="col-xl-6">
                  <div class="about-two__content">
                      <div class="block-title text-left">
                          <h2 class="block-title__title">Transformative  <br>
                              Solutions</h2><!-- /.block-title__title -->
                      </div><!-- /.block-title -->
                      ...
                      <div class="about-two__single-wrap">
                          <div class="about-two__single">
                              ...
                              <div class="about-two__single-content">
                                  <p class="about-two__single-text">Talk to 
                                      our experts about your project</p><!-- /.about-two__single-text -->
                          ...
                          <div class="about-two__single">
                              ...
                              <div class="about-two__single-content">
                                  <p class="about-two__single-text">Start growing your business with us
              ...
              <div class="col-xl-6 d-flex justify-content-xl-end justify-content-sm-center">
                  <div class="about-two__image">
                      ...
                      <img src="/assets/images/about-1-1-1.jpg" alt="">
