    ...
    <div>
      <footer class="site-footer">
                          ...
                          <div class="row">
                              <div class="col-xl-3 col-lg-6 col-sm-12">
                                  <div class="footer-widget footer-widget__contact">
                                      <h2 class="footer-widget__title">Projects</h2><!-- /.footer-widget__title -->
                                      <ul class="list-unstyled footer-widget__course-list">
                                          <li>
                                              <h2><a href="course-details.html">Textile in Kenya</a></h2>
                                              <p>Mike Hardson</p>
                                          </li>
                                          <li>
                                              <h2><a href="course-details.html"> Water Project in Sudan </a></h2>
                                              <p>Jessica Brown</p>
                                          </li>
                  ...
                  <div class="site-footer__bottom">
                      <div class="container">
                          <p class="site-footer__copy">&copy; Copyright 2020 by <a href="#">adfg.com</a></p>
