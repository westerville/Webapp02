  ...
  <div class="banner-wrapper">
      <section class="banner-one banner-carousel__one no-dots owl-theme owl-carousel">
          <div class="banner-one__slide banner-one__slide-one">
              <div class="container">
                  ...
                  <img src="/assets/images/slider-1-person-1-1.png" class="banner-one__person" alt="">
                  <div class="row no-gutters">
                      <div class="col-xl-12">
                          <h3 class="banner-one__title banner-one__light-color">Driving <br>
                              Development</h3><!-- /.banner-one__title -->
                          <p class="banner-one__tag-line">through community integration</p><!-- /.banner-one__tag-line -->
          ...
          <div class="banner-one__slide banner-one__slide-two">
              <div class="container">
                  ...
                  <div class="banner-one__bubble-3"></div><!-- /.banner-one__bubble- -->
                  <img src="/assets/images/slider-1-scratch.png" alt="" class="banner-one__scratch">
                  <img src="/assets/images/slider-1-person-2-2.png" class="banner-one__person" alt="">
                  <div class="row no-gutters">
                      <div class="col-xl-12">
                          <h3 class="banner-one__title banner-one__light-color">Focus On <br>
                              Africa</h3><!-- /.banner-one__title -->
                          <p class="banner-one__tag-line">empowering women</p><!-- /.banner-one__tag-line -->
                          <a href="#" class="thm-btn banner-one__btn">Learn More</a>
                      </div><!-- /.col-xl-12 -->
                  </div><!-- /.row -->
              </div><!-- /.container -->
      ...
      <div class="banner-one__cta">
          ...
          <div class="banner-one__cta-title">
              <h3 class="banner-one__cta-text"><a href="#">Read how we encourage empower
                      women through education</a></h3><!-- /.banner-one__cta-text -->
